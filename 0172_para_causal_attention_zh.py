...
# SAVE_DIR = Path("outputs/try/causal_attention/attention_weights_zh")
SAVE_DIR = Path("outputs/try/causal_attention/attention_weights_zh_para")
...
def process_sample(model, sample: dict):
    ...
    block_split = find_causal_block(prompt, labels, lang="zh")
